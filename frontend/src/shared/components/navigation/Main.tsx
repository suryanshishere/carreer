...
const MainNavigation: React.FC = () => {
  ...
  return (
    <div className="main_nav_sec fixed w-full flex flex-col items-center gap-2 pb-1 z-20">
      ...
      {showSubNav && (
        <div
          className={`sub_main_nav w-full flex justify-between items-center gap-2 transition-transform duration-300`}
        >
          <Navlinks />
          <Features />
          <Response />
