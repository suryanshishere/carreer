...
const posts_routes_1 = __importDefault(require("src/routes/posts/posts-routes"));
const admin_routes_1 = __importDefault(require("src/routes/admin/admin-routes"));
const other_routes_1 = __importDefault(require("src/routes/other/other-routes"));
const user_routes_1 = __importDefault(require("src/routes/users/user-routes"));
const http_errors_1 = __importDefault(require("src/utils/http-errors"));
const user_cleanup_task_1 = __importDefault(require("src/middleware/cronJobs/user-cleanup-task"));
const check_auth_1 = __importDefault(require("src/middleware/check-auth"));
const check_account_status_1 = __importDefault(require("src/middleware/check-account-status"));
const activate_account_1 = __importDefault(require("src/middleware/activate-account"));
const publisher_controllers_1 = require("@controllers/admin/publisher/publisher-controllers");
const publisher_routes_1 = __importDefault(require("src/routes/admin/publisher/publisher-routes"));
