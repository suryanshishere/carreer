...
export const NON_REQUIRED_FIELD: Record<string, boolean> = {
  ...
  "result_ref.result.current_year.general": true,
  "result_ref.result.current_year.obc": true,
  "result_ref.result.current_year.ews": true,
  "result_ref.result.current_year.sc": true,
  "result_ref.result.current_year.st": true,
  "result_ref.result.current_year.ph_dviyang": true, 
  "result_ref.result.previous_year.general": true,
  "result_ref.result.previous_year.obc": true,
  "result_ref.result.previous_year.ews": true,
  "result_ref.result.previous_year.sc": true,
  "result_ref.result.previous_year.st": true,
  "result_ref.result.previous_year.ph_dviyang": true, 
