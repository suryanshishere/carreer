...
const certificateVerificationPromptSchema = {
  ...
  properties: {
    how_to_fill_the_form: {
      ...
      description: `Step-by-step instructions to fill the certificate verification form, within ${POST_LIMITS_ENV_DB.long_char_limit.min}-${POST_LIMITS_ENV_DB.long_char_limit.max} characters.`,
    },
  },
