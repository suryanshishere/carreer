...
const admitCardPromptSchema = {
  ...
  properties: {
    how_to_download_admit_card: {
      ...
      description: `Step-by-step instructions to download the admit card, within ${POST_LIMITS_DB.long_char_limit.min}-${POST_LIMITS_DB.long_char_limit.max} characters.`,
    },
  },
